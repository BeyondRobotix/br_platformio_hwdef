...
# Copied verbatim from platform-ststm32 builder/main.py (version 19.6.0).
# Sets up the ARM toolchain, build targets, and upload protocol handlers
# (stlink via openocd, jlink, blackmagic, dfu, serial, hid, custom).
